    ...
    return (
        <div className={styles.bgimg}>
            <Head>
                ...
                <meta name="description" content="Hi, I'm Niklas, a 21 year old aspiring software developer. Let's chat!"/>
            ...
            <div
                ...
                <div
                    className={"bg-gradient-to-r from-startingblue to-endingpurple bg-fixed bg-center bg-cover bg-no-repeat min-w-fit min-h-fit md:min-w-0 md:h-1/2 w-1/2 p-4 lg:w-3/4 lg:h-3/4 rounded-3xl border hover:border-blue-500 text-center hover:bg-clip-text hover:text-transparent hover:shadow-2xl hover:transition-all transition-all duration-500"}>
                    <div className={"font-black text-5xl sm:text-6xl lg:text-9xl xl:text-extrabig"}>👋 Hi there!</div>
                    <div className={"pt-5 text-xl sm:text-4xl"}>I am Niklas, 21 year old geek and aspiring software engineer living in Vienna.
                    </div>
                </div>
            </div>
            <SocialLinks/>
